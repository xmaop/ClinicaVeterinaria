<%@ Page Title="" Language="C#" MasterPageFile="~/Administrador.master" AutoEventWireup="true" CodeFile="ActualizarInfChip.aspx.cs" Inherits="ActualizarInfChip" %>
		        ...
		        <div class="span12">
			        <div class="widget-box">
				        <div class="widget-header widget-header-blue widget-header-flat">
					        <h4><span class="auto-style1">Desactivar chip</span>&nbsp;
                            </h4>
				        </div>
                        <div>
                            &nbsp;&nbsp;
                        ...
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input id="Text3" style="background-color: #FFFFFF" type="text" width="40" /> Pendiente<input id="Text1" style="background-color: #00FF00" type="text" width="40" /> Terminado&nbsp; 
                                ...
                                <div class=" row-fluid position-relative">
                                    <ig:WebExcelExporter ID="eExporter" ExportMode="Download" runat="server" DisableCellValueFormatting="true"></ig:WebExcelExporter>
                                         ...
                                         <Columns>
                                             ...
                                             <ItemTemplate>
                                                 <asp:ImageButton ID="imgEditar" runat="server" ToolTip="Desafiliar" CommandName="Desafiliar" Width="20px"  Height="20px" CommandArgument='<%# DataBinder.Eval(((Infragistics.Web.UI.TemplateContainer)Container).DataItem, "idOrdenAtencion") %>' ImageUrl="~/Images/ic_action_info.png" OnClick="imageBtnDesafiliar_Click"/>
                                             </ItemTemplate>
                                    ...
                                    <div class="panel-footer" style="text-align:left; padding:10px 20px 10px 20px">
                                        <asp:SqlDataSource 
                                            ...
                                            SelectCommand="ACI_USP_VET_sel_OrdenesDisponiblesActualizacionId" 
