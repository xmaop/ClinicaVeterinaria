...
public partial class RegistraImpChip : System.Web.UI.Page
{
    ...
    private DataTable CargarListaUsuarios()
    {
        DataTable dt = new DataTable();

        dt = oUsuarioBL.ListaUsuarios();
    ...
    protected void imageBtnEditar_Click(object sender, ImageClickEventArgs e)
    {
        ...
        string URL = "";
        URL = "RegistraImpChipEditar.aspx?X=" + strURLEcriptado;
        Response.Redirect(URL, true);
        Context.ApplicationInstance.CompleteRequest();
    }
