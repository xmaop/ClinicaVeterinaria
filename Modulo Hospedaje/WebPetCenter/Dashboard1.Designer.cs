namespace WebPetCenter
{
    partial class Dashboard1
    {
        ...
        private void InitializeComponent()
        {
            ...
            dimension2.DataMember = "GCP_Especie_Descripcion";
            measure1.DataMember = "Descripcion";
            ...
            this.pieDashboardItem1.Name = "Distribucion de Pacientes por Especie";
            ...
            this.dashboardSqlDataSource1.Name = "Distribucion segun Razas";
            storedProcQuery1.Name = "Query";
            queryParameter1.Name = "@FechaSim";
            queryParameter1.Type = typeof(DevExpress.DataAccess.Expression);
            queryParameter1.Value = new DevExpress.DataAccess.Expression("[Parameters.FechaSim]", typeof(System.DateTime));
            storedProcQuery1.Parameters.Add(queryParameter1);
            storedProcQuery1.StoredProcName = "GHA_USP_VET_rpt_DistribucionMascotas";
            ...
            this.chartDashboardItem1.Name = "Capacidad de Caniles";
            ...
            this.dashboardSqlDataSource4.ConnectionName = "VeterinariaConnectionString";
            this.dashboardSqlDataSource4.Name = "Capacidad de Caniles";
            storedProcQuery2.Name = "GHA_USP_VET_rpt_CapacidadCaniles";
            queryParameter2.Name = "@FechaSim";
            queryParameter2.Type = typeof(DevExpress.DataAccess.Expression);
            queryParameter2.Value = new DevExpress.DataAccess.Expression("[Parameters.FechaSim]", typeof(System.DateTime));
            storedProcQuery2.Parameters.Add(queryParameter2);
            storedProcQuery2.StoredProcName = "GHA_USP_VET_rpt_CapacidadCaniles";
            ...
            this.chartDashboardItem2.Name = "Resumen de Servicios";
            chartPane2.Name = "Panel 1";
            ...
            // gridDashboardItem1
            // 
            dimension4.DataMember = "Codigo Reserva";
            gridDimensionColumn1.FixedWidth = 18.151897499831257D;
            gridDimensionColumn1.Weight = 77.86153368508765D;
            gridDimensionColumn1.WidthType = DevExpress.DashboardCommon.GridColumnFixedWidthType.Weight;
            gridDimensionColumn1.AddDataItem("Dimension", dimension4);
            dimension5.DataMember = "Codigo Paciente";
            gridDimensionColumn2.Weight = 62.289226948070109D;
            ...
            dimension6.DataMember = "Paciente";
            gridDimensionColumn3.Weight = 73.7089185552163D;
            ...
            gridDimensionColumn4.FixedWidth = 10.158401353116576D;
            gridDimensionColumn4.Weight = 54.464285714285715D;
            gridDimensionColumn4.WidthType = DevExpress.DashboardCommon.GridColumnFixedWidthType.FixedWidth;
            gridDimensionColumn4.AddDataItem("Dimension", dimension7);
            dimension8.DataMember = "Fecha Inicio";
            ...
            gridDimensionColumn5.Weight = 52.383808609816292D;
            gridDimensionColumn5.WidthType = DevExpress.DashboardCommon.GridColumnFixedWidthType.FitToContent;
            gridDimensionColumn5.AddDataItem("Dimension", dimension8);
            dimension9.DataMember = "Fecha Fin";
            dimension9.DateTimeGroupInterval = DevExpress.DashboardCommon.DateTimeGroupInterval.DayMonthYear;
            gridDimensionColumn6.Weight = 130.57992870852755D;
            gridDimensionColumn6.WidthType = DevExpress.DashboardCommon.GridColumnFixedWidthType.FitToContent;
            gridDimensionColumn6.AddDataItem("Dimension", dimension9);
            dimension10.DataMember = "Observacion";
            gridDimensionColumn7.Weight = 60.734850562105841D;
            gridDimensionColumn7.WidthType = DevExpress.DashboardCommon.GridColumnFixedWidthType.FitToContent;
            ...
            this.gridDashboardItem1.DataItemRepository.Add(dimension10, "DataItem5");
            ...
            dashboardLayoutItem1.Weight = 30.911680911680911D;
            dashboardLayoutItem2.DashboardItem = this.chartDashboardItem1;
            dashboardLayoutItem2.Weight = 36.182336182336179D;
            dashboardLayoutItem3.DashboardItem = this.chartDashboardItem2;
            dashboardLayoutItem3.Weight = 32.9059829059829D;
            dashboardLayoutGroup2.ChildNodes.AddRange(new DevExpress.DashboardCommon.DashboardLayoutNode[] {
            dashboardLayoutItem1,
            dashboardLayoutItem2,
            dashboardLayoutItem3});
            dashboardLayoutGroup2.DashboardItem = null;
            dashboardLayoutGroup2.Weight = 60.040160642570278D;
            dashboardLayoutItem4.DashboardItem = this.gridDashboardItem1;
            dashboardLayoutItem4.Weight = 39.959839357429722D;
