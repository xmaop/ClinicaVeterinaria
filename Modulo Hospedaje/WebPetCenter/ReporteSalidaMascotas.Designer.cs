...
{
    partial class ReporteSalidaMascotas
    {
        /// <summary> 
        ...
        private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ReporteSalidaMascotas));
            ...
            measure1.DataMember = "Ingreso";
            measure2.DataMember = "Salida";
            ...
            simpleSeries1.Name = "Ingreso de Pacientes";
            simpleSeries1.AddDataItem("Value", measure1);
            simpleSeries2.Name = "Salida de Pacientes";
            ...
            this.dashboardSqlDataSource2.Name = "Origen de datos SQL 2";
            storedProcQuery1.Name = "GHA_USP_DataChartIngresoSalidas";
            queryParameter1.Name = "@FIngreso";
            queryParameter1.Type = typeof(DevExpress.DataAccess.Expression);
            queryParameter1.Value = new DevExpress.DataAccess.Expression("[Parameters.FechaIngreso]", typeof(System.DateTime));
            queryParameter2.Name = "@FSalida";
            queryParameter2.Type = typeof(DevExpress.DataAccess.Expression);
            queryParameter2.Value = new DevExpress.DataAccess.Expression("[Parameters.FechaSalida]", typeof(System.DateTime));
            storedProcQuery1.Parameters.Add(queryParameter1);
            storedProcQuery1.Parameters.Add(queryParameter2);
            storedProcQuery1.StoredProcName = "GHA_USP_DataChartIngresoSalidas";
            ...
            dimension5.DataMember = "NombrePaciente";
            ...
            queryParameter5.Name = "@FSalida";
            queryParameter5.Type = typeof(DevExpress.DataAccess.Expression);
            queryParameter5.Value = new DevExpress.DataAccess.Expression("[Parameters.FechaSalida]", typeof(System.DateTime));
            ...
            dashboardParameter1.Name = "CodigoExpediente";
            ...
            dashboardParameter2,
            dashboardParameter3});
            this.Title.Text = "Reporte de Ingreso y Salida de Pacientes";
