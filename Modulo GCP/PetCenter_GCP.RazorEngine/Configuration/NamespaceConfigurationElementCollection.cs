// Type: RazorEngine.Configuration.NamespaceConfigurationElementCollection
...
namespace PetCenter_GCP.RazorEngine.Configuration
{
  ...
  public class NamespaceConfigurationElementCollection : ConfigurationElementCollection
  {
    ...
    {
      return (ConfigurationElement) new NamespaceConfigurationElement();
    }

    protected override object GetElementKey(ConfigurationElement element)
    {
      return (object) ((NamespaceConfigurationElement) element).Namespace;
    }
  }
}
