<%@ Page Title="Administrar cuenta" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Manage.aspx.cs" Inherits="PETCenter.WebApplication.Account.Manage" %>
                ...
                <tr>
                    ...
                    <td>
                        <asp:Button runat="server" Text="Quitar" CommandName="Delete" CausesValidation="false" 
                            ToolTip='<%# "Quitar este " + Item<OpenAuthAccountData>().ProviderDisplayName + " inicio de sesión de su cuenta" %>'
